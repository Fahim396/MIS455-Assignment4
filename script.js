...
function displayCountries(countries) {
    ...
    countries.forEach(country => {
        ...
        card.innerHTML = `
            ...
            <p><strong>Continent:</strong> ${country.continents?.[0] || "N/A"}</p>
            <p><strong>Currency:</strong> ${currency.name} (${currency.symbol})</p>
            <button class="btn btn-primary mt-3" onclick="getWeather(${country.latlng?.[0] || 0}, ${country.latlng?.[1] || 0}, '${country.name.common}')">View Weather</button>
        `;
